...
df_total.to_pickle('df_freshman_original.pkl')

######  读取Pickle文件
# df_freshman_original = pd.read_pickle('df_freshman_original.pkl')
# df_freshman_original.shape  ## (1674, 186)
df_total = pd.read_pickle('df_freshman_original.pkl')
# df_total.shape  ## (1674, 186)
# df_total.columns

###### 輸出成外部 excel 檔
df_total.to_excel(r'C:\Users\user\Dropbox\系務\校務研究IR\大一新生學習適應調查分析\112\final\df_freshman_original.xlsx',index=False)
